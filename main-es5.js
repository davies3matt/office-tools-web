...
var BottomFrameComponent = /** @class */ (function () {
    function BottomFrameComponent() {
    }
    BottomFrameComponent.prototype.openGit = function () {
        window.open("https://github.com/frankAwesome/ITRW324Group21");
    };
    BottomFrameComponent.prototype.openSlack = function () {
        window.open("https://app.slack.com/client/TLLKMFSTY/GLJURMYH0");
    };
    BottomFrameComponent.prototype.ngOnInit = function () {
    };
...
var DesktopPageComponent = /** @class */ (function () {
    function DesktopPageComponent() {
    }
    DesktopPageComponent.prototype.clickFileTransfer = function () {
    };
    DesktopPageComponent.prototype.ngOnInit = function () {
    };
...
var FileTransferPageComponent = /** @class */ (function () {
    function FileTransferPageComponent() {
    }
    FileTransferPageComponent.prototype.ngOnInit = function () {
    };
    ...
    return FileTransferPageComponent;
}());
...
var HomePageComponent = /** @class */ (function () {
    ...
    HomePageComponent.prototype.getNext = function () {
        this.page++;
        this.title = this.http.get(this.ROOT_URL1 + '/' + this.page).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (post) { return post.title; }));
        this.getSubtitle();
        this.getArticle();
        this.getDay();
        this.getMonth();
    ...
    HomePageComponent.prototype.getPrev = function () {
        this.page--;
        this.title = this.http.get(this.ROOT_URL1 + '/' + this.page).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (post) { return post.title; }));
        this.getSubtitle();
        this.getArticle();
    ...
    HomePageComponent.prototype.getTitle = function () {
        this.title = this.http.get(this.ROOT_URL1 + '/' + this.page).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (post) { return post.title; }));
        this.getSubtitle();
        this.getArticle();
        this.getDay();
    ...
    HomePageComponent.prototype.getSubtitle = function () {
        this.subtitle = this.http.get(this.ROOT_URL1 + '/' + this.page).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (post) { return post.subtitle; }));
    };
    HomePageComponent.prototype.getArticle = function () {
        this.article = this.http.get(this.ROOT_URL1 + '/' + this.page).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (post) { return post.article; }));
    };
    HomePageComponent.prototype.getDay = function () {
        this.day = this.http.get(this.ROOT_URL1 + '/' + this.page).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (post) { return post.day; }));
    };
    HomePageComponent.prototype.getMonth = function () {
        this.month = this.http.get(this.ROOT_URL1 + '/' + this.page).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (post) { return post.month; }));
    };
    HomePageComponent.prototype.getURL1 = function () {
        this.url1 = this.http.get(this.ROOT_URL1 + '/' + this.page).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (post) { return post.urlone; }));
    };
    HomePageComponent.prototype.getURL2 = function () {
        this.url2 = this.http.get(this.ROOT_URL1 + '/' + this.page).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (post) { return post.urltwo; }));
    };
...
var ManualPageComponent = /** @class */ (function () {
    function ManualPageComponent() {
    }
    ManualPageComponent.prototype.ngOnInit = function () {
    };
...
var MobilePageComponent = /** @class */ (function () {
    ...
    MobilePageComponent.prototype.ngOnInit = function () {
    };
...
var VideoCallPageComponent = /** @class */ (function () {
    function VideoCallPageComponent() {
    }
    VideoCallPageComponent.prototype.ngOnInit = function () {
    };
...
var VoiceNotePageComponent = /** @class */ (function () {
    function VoiceNotePageComponent() {
    }
    VoiceNotePageComponent.prototype.ngOnInit = function () {
    };
